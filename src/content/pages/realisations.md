...
Découvrez quelques-unes de mes créations, des modèles uniques et de caractère, conçus et fabriqués à Reims, en France. Qu'il s'agisse de pièces en bois ou en cuir, chaque objet est imaginé pour vous.

<div id="gallery-controls">

<div class="gallery-filters" id="gallery-filters" role="group" aria-label="Filtrer par catégorie">
  <button type="button" data-filter="toutes" aria-pressed="true">Toutes</button>
  <button type="button" data-filter="tabletterie" aria-pressed="false">Tabletterie</button>
  <button type="button" data-filter="marqueterie" aria-pressed="false">Marqueterie</button>
  <button type="button" data-filter="gainerie" aria-pressed="false">Gainerie</button>
  <button type="button" data-filter="mobilier" aria-pressed="false">Mobilier</button>
</div>

<p class="gallery-status" id="gallery-status" aria-live="polite" aria-atomic="true"></p>
